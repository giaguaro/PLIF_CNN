...
def parse_args():
    ...
    parser.add_argument("--model-path", default='/groups/cherkasvgrp/share/progressive_docking/hmslati/plif_cnn/new_model/checkpoint_model_20221010.pth', 
...
## test the model productivity ##
    train_data, validate_data = train_data[:100], train_data[:100]
#################################
